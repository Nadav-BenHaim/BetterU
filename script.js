...
//
const buttonSound = new Howl({ src: ['button-8'], html5: true });
const sendSound = new Howl({ src: ['message-sent'], html5: true });
const errorSound = new Howl({ src: ['error_01'], html5: true });
